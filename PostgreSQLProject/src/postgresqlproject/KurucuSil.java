...
public class KurucuSil extends javax.swing.JFrame {

    /**
     * Creates new form KurucuSil
     */
    Connection conn = getConnection();

    public KurucuSil() {
        initComponents();
        this.setTitle("Kurucu Sil");
    ...
    private void btnSilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSilActionPerformed
        ...
        if (conn != null) {
            ...
            try {
                String sql = "DELETE FROM \"kurucu\" WHERE \"kurucuId\" = " + id;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KurucuSil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
